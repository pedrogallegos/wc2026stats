...
export default function FullBracket({ roundOf32 }: Props) {
  ...
  const MatchBox = ({ title, matchId, t1, t2 }: { title: string; matchId: string; t1: any; t2: any }) => {
    ...
    return (
      ...
      >
        <div className={`glass rounded-lg border p-1 w-48 shadow-lg flex flex-col justify-center relative z-10 transition-colors ${
          ...
          <div className="flex flex-col gap-1">
            <div className="h-7 bg-slate-800/50 rounded flex items-center overflow-hidden">
  ...
  return (
    <div className="overflow-x-auto w-full pb-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8 sticky left-0 z-20">
        <div className="flex items-center gap-4">
          <h2 className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-sky-400">
            Official Knockout Bracket
          </h2>
          <div className="h-px w-32 bg-gradient-to-r from-sky-500/50 to-transparent"></div>
        </div>

        <div className="flex items-center gap-4 bg-slate-900 p-2 rounded-xl border border-white/10 shadow-xl">
